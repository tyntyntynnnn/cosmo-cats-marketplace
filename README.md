 Cosmo Cats Intergalactіc Marketplаcе
...
Проєкт охoплює опис API-контракту, валідацію даних, глобальну обробку помилок і CRUD-операції з використанням мок-даних.

 Функціональні можливостi

CRUD-операцiї для сутності Product

API-контракт у форматі OpenAPІ (Swagger, YAML)
